...
public final class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account,
        ...
        System.out.println("AuthToken1: " + token);
        ...
        if (TextUtils.isEmpty(token)) {
            ...
            System.out.println("AuthToken2:"+ refreshToken);
            ...
            if (TextUtils.isEmpty(refreshToken)) {
                ...
                try {
                    ...
                    System.out.println("Khawar ZoP: AccessToken:" + tokenResponse.getAccessToken());
                    System.out.println("Khawar ZoP: RefreshToken:" + tokenResponse.getRefreshToken());
                } catch (OIDCNotReadyException e) {
    ...
    private Intent createIntentForAuthorization(AccountAuthenticatorResponse response) throws OIDCNotReadyException {
        ...
        System.out.println("Khawar ZoP: " + TAG + " authUrl " + authUrl);
