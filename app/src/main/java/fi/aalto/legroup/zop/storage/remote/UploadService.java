...
import fi.aalto.legroup.zop.storage.remote.upload.MetadataUploader;
...
public final class UploadService extends IntentService {
    ...
    private boolean tryUpload(Video video) {
        ...
        System.out.println("Khawar ZoP: start uploading video ");
        for (VideoUploader uploader : videoUploaders) {
            try {
                ...
                e.printStackTrace();
                System.out.println("Khawar ZoP: uploading video => " + e.getMessage());

            }
        }

        if (videoResult == null) {
            System.out.println("Khawar ZoP: no video result found ");
        ...
        if (videoResult.thumbUrl != null) {
            ...
            System.out.println("Khawar ZoP: uploading video thumbnail");
            ...
            for (ThumbnailUploader uploader : thumbUploaders) {
                try {
                    ...
                    e.printStackTrace();
                    System.out.println("Khawar ZoP: uploading video thumbnail error => " + e.getMessage());
        ...
        try {
            System.out.println("Khawar ZoP: uploading video manifest");
            ...
            ee.printStackTrace();
            System.out.println("Khawar ZoP: uploading video manifest error => " + ee.getMessage());
