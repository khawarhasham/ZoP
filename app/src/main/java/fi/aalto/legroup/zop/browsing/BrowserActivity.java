...
import fi.aalto.legroup.zop.authentication.LoginActivity;
import fi.aalto.legroup.zop.authentication.LoginErrorEvent;
import fi.aalto.legroup.zop.authentication.LoginRequestEvent;
import fi.aalto.legroup.zop.authentication.LoginStateEvent;
import fi.aalto.legroup.zop.authentication.OIDCConfig;
import fi.aalto.legroup.zop.authoring.QRHelper;
import fi.aalto.legroup.zop.authoring.VideoCreatorService;
import fi.aalto.legroup.zop.settings.SettingsActivity;
import fi.aalto.legroup.zop.settings.UserProfileActivity;
import fi.aalto.legroup.zop.sharing.SharingActivity;
import fi.aalto.legroup.zop.storage.VideoRepositoryUpdatedEvent;
import fi.aalto.legroup.zop.storage.remote.SyncRequiredEvent;
import fi.aalto.legroup.zop.storage.remote.SyncService;
import fi.aalto.legroup.zop.storage.remote.UploadStateEvent;
import fi.aalto.legroup.zop.utilities.BaseActivity;
import fi.aalto.legroup.zop.utilities.ProgressDialogFragment;
import fi.aalto.legroup.zop.views.adapters.VideoTabAdapter;
